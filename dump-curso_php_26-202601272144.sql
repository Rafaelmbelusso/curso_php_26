...
CREATE TABLE `endereco` (
  ...
  `criado_em` timestamp NULL DEFAULT NULL,
  `atualizado_em` timestamp NULL DEFAULT NULL,
  `usuario-alteracao` smallint(6) DEFAULT NULL,
...
INSERT INTO `usuario` VALUES (1,'Ariel'),(2,'Rafael'),(3,'Felipe'),(4,'Ariel'),(5,'Tiago'),(6,'Bruno'),(7,'Felipe'),(8,'Henrique B'),(9,'Pedro');
...
-- Dump completed on 2026-01-27 21:44:55
